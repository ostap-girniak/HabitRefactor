...
> 👤 **Просто хочеш користуватись додатком?** Відкрий лінк у [Живій демоверсії](#-жива-демоверсія) вище — нічого ставити не потрібно.
>
> 🛠️ **Хочеш розробляти або self-host?** Йди далі по кроках щоб запустити свою копію локально.
